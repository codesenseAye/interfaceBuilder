    ...
    let getInput = () => {
      if (propertyType == "number") {
        ...
        for (let fontName in enums[this.props.name]) {
          fonts.push( /*#__PURE__*/React.createElement("option", {
            value: fontName
          }, fontName));
        }
        ...
        }, typeof image == "object" ? image.path : typeof image == "string" ? image : "SELECT IMAGE"), /*#__PURE__*/React.createElement("button", {
          id: this.id + "_reset",
          style: {
            marginLeft: "10px",
...
class PropertyView extends react.Component {
  ...
  render() {
    ...
    for (let key in properties[this.props.element.state.ClassName]) {
      elements.push( /*#__PURE__*/React.createElement(Property, {
        key: Math.random() * 1e9,
        element: this.props.element,
        name: key,
        existing: this.props.element.state.props[key]
      }));
    }
